...
class Formas3 extends React.Component {
        state = {
                opcao: this.props.id,
        }
        render() {
...
const mapState = state => ({
        estadoInputCount1: state.inputTextRedux3A,
        estadoInputCount2: state.inputTextRedux3B,
        estadoInputCount3: state.inputTextRedux3C,
        estadoInputCount4: state.inputTextRedux3D,
})

export default connect(mapState)(Formas3);